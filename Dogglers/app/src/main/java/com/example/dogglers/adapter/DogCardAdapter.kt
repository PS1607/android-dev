...
class DogCardAdapter(
    ...
    class DogCardViewHolder(private val view: View): RecyclerView.ViewHolder(view) {
        ...
        val textViewAge: TextView = view.findViewById(R.id.dogAge)
        val textViewHobby: TextView = view.findViewById(R.id.dogHobby)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.textViewName.text =  resources?.getString(R.string.dog_name, dog.name)
